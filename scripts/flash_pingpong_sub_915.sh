...
# ==========================================================
# FLASH PINGPONG SUBORDINATE (915 MHz)
# ==========================================================
...
echo "Building application: PINGPONG (SUBORDINATE) at 915 MHz..."
west build -p -b xiao_nrf54l15/nrf54l15/cpuapp "$PROJECT_ROOT" -d "$PROJECT_ROOT/build" --shield semtech_wio_lr2021 -- -DAPP_TYPE=pingpong -DEXTRA_CFLAGS="-DPINGPONG_DEVICE_MODE=2 -DRF_FREQ_IN_HZ=915000000"
