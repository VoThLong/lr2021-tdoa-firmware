...
echo "Building application: PINGPONG (SUBORDINATE) with PREAMBLE 245..."
west build -b xiao_nrf54l15/nrf54l15/cpuapp --shield semtech_wio_lr2021 -- -DAPP_TYPE=pingpong -DEXTRA_CFLAGS="-DLORA_PREAMBLE_LENGTH=245"
