...
echo "Building application: RANGING (MANAGER) at 915 MHz..."
west build -p -b xiao_nrf54l15/nrf54l15/cpuapp "$PROJECT_ROOT" -d "$PROJECT_ROOT/build" --shield semtech_wio_lr2021 -- -DAPP_TYPE=ranging -DEXTRA_CFLAGS="-DRANGING_DEVICE_MODE=2 -DRF_FREQ_IN_HZ=915000000"
